...
public class AdocaoService {
    ...
    public void solicitar(SolicitacaoAdocaoDto dto) {
        ...
        emailService.enviarEmail(adocao.getPet().getAbrigo().getEmail(), "Solicitação de adoção", "Olá "
    ...
    public void aprovar(AprovacaoAdocaoDto dto) {
        ...
        adocao.alteraStatusParaAprovado();

        emailService.enviarEmail(adocao.getTutor().getEmail(), "Adoção aprovada", "Parabéns "
    ...
    public void reprovar(ReprovacaoAdocaoDto dto) {
        Adocao adocao = adocaoRepository.getReferenceById(dto.idAdocao());
        adocao.alteraStatusParaReprovado(dto.justificativa());

        emailService.enviarEmail(adocao.getTutor().getEmail(), "Adoção reprovada", "Olá "
                + adocao.getTutor().getNome()
